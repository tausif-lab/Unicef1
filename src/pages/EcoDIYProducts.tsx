  ...
  const products: Product[] = [
    {
      ...
      reviews: 234,
      category: 'home-decor',
      description: 'Beautiful handcrafted planter made from 100% recycled ocean plastic. Perfect for indoor plants and succulents. Waterproof and durable design.',
      features: ['Drainage holes included', 'UV resistant', 'Weatherproof', 'Lightweight design'],
      materials: '100% Recycled Ocean Plastic',
      sustainability: 'Each planter saves 500g of plastic from entering the ocean'
    },
    {
      id: 2,
